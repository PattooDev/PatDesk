...
- La branche `patdesk-disques-test` est une branche historique. Au 26 août 2026, son arbre Git est identique à celui de `main`, malgré un historique divergent. Ne pas la fusionner ni la supprimer sans demande explicite.
